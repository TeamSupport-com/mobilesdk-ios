#
#  Be sure to run `pod spec lint SnapEngageSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "SnapEngage" => "dev@SnapEngage.com" }

  # Or just: spec.author    = "SnapEngage"
  # spec.authors            = { "SnapEngage" => "dev@SnapEngage.com" }
  ...
  spec.source = { :git => 'https://github.com/SnapEngage/mobilesdk-ios.git', :tag => "#{spec.version}" }
